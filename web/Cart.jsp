    ...
    <body>
            ...
            <div class="shopping-cart">
                <div class="px-4 px-lg-0">
                    <div class="pb-5">
                        <div class="container">
                            <a href="shop" class="btn btn-lg btn-success md-btn-flat mt-2 mr-3">Trở về trang chủ</a>
                            <div class="row">
                                            ...
                                            <c:forEach items="${cart.items}" var="i">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="cart?num=-1&id=${i.product.id}"><button class="btnSub">-</button></a> 
                                                        <strong>${i.quantity}</strong>
                                                        <a href="cart?num=1&id=${i.product.id}"><button class="btnAdd">+</button></a>
                                                    </td>
                                                    <td class="align-middle"><strong>${i.product.price*i.quantity}</strong></td>   
                                                    <td class="align-middle">
                                                        <a href="cart?num=0&id=${i.product.id}"><button class="btn btn-danger">Delete</button></a> 
                                                    </td>
                                                </tr> 
                                            </c:forEach>
                                        </tbody>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong>${cart.totalMoney*0.05}</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${cart.totalMoney + cart.totalMoney*0.05}</h5>
                                        </li>
